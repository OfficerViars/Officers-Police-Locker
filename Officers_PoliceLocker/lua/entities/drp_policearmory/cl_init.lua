...
if PoliceLocker.Config.Overhead == true then
	...
	Ang:RotateAroundAxis(Ang:Up(), 90)
		...
		draw.SimpleText( PoliceLocker.Config.Language.LockerOverhead, "maintext", 0, 46, Color(255,255,255,150), 1, 0 )
		cam.End3D2D()
	end
end
...
function ArmoryPoliceMenu()
	...
	if PoliceLocker.Config.PrimaryTab == true then
	...
	then
		...
		if PoliceLocker.Config.SecondaryTab == true then
	...
	then
		...
		if PoliceLocker.Config.ArmorTab == true then
	...
	then
		...
		if PoliceLocker.Config.HealthTab == true then
	...
	then
		...
		if PoliceLocker.Config.AmmoTab == true then
